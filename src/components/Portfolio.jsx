...
const projects = [
  ...
  {
    name: 'Andrea Buralli',
    category: 'Trauerbegleitung · In Umsetzung',
    description: 'Webseite für Familientrauerbegleitung in Zürich. Ruhiges, einfühlsames Design für ein sensibles Thema.',
    image: '/work/andrea-silk-desktop.jpg',
    href: 'https://andrea-silk.vercel.app',
    linkLabel: 'Vorschau ansehen',
  },
  {
    name: 'Driven Co.',
